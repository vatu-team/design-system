...
/**
 * Service: Blocks Single Template
 *
...
final class BlocksSingleTemplate extends Service implements Registrable
{
	...
	public function addTemplate(): void
	{
		register_block_template(
			template_name: 'design-system//single-vatu_blocks',
			args: [
				'title'       => 'Single Blocks',
				'description' => 'Single page for Blocks',
	...
	{
		ob_start();
		include TEMPLATE_DIR . '/single-vatu_blocks.html';
		$output = ob_get_clean();
