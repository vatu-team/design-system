...
final class StyleGuideContent extends PostContentType
{
	protected string $content_type = 'vatu_style_guide';
	...
	public function getContentArgs(): array
	{
		return ( new ContentSettings(
			...
			label: __( 'Style Guide', 'design-system' ),
			labels: [
				'singular_name' => __( 'Style Guide', 'design-system' ),
				'menu_name'     => __( 'Style Guide', 'design-system' ),
			],
			public: true,
