...
final class StyleGuideContentMenu extends Service implements Registrable
{
	...
	public function addMenu(): void
	{
		...
		\add_submenu_page(
			...
			page_title: __( 'Style Guide', 'design-system' ),
			menu_title: __( 'Style Guide', 'design-system' ),
			capability: 'edit_pages',
			menu_slug: 'edit.php?post_type=vatu_style_guide'
		);
	}
}
