...
final class PatternsContentMenu extends Service implements Registrable
{
	...
	public function addMenu(): void
	{
		...
		\add_submenu_page(
			...
			page_title: __( 'Patterns', 'design-system' ),
			menu_title: __( 'Patterns', 'design-system' ),
			capability: 'edit_pages',
			menu_slug: 'edit.php?post_type=vatu_patterns'
		);
	}
}
